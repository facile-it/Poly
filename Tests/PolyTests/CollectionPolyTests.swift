...
class CollectionPolyTests: XCTestCase {
    ...
    func test_TwelveDifferentTypes() {
        let values = decoded(type: [Poly12<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12>].self,
                             data: twelve_different_type_values)
    ...
    func test_TwelveDifferentTypes_encode() {
        test_DecodeEncodeEquality(type: [Poly12<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12>].self,
                                  data: twelve_different_type_values)
    }
    
    func test_ThirteenDifferentTypes() {
        let values = decoded(type: [Poly13<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13>].self,
    ...
    func test_ThirteenDifferentTypes_encode() {
    ...
    func test_FourteenDifferentTypes() {
        ...
        XCTAssertEqual(values[TestType12.self].count, 1)
        XCTAssertEqual(values[TestType13.self].count, 1)
        XCTAssertEqual(values[TestType14.self].count, 1)
    }

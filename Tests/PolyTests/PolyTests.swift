...
class PolyTests: XCTestCase {
    ...
    func test_init_Poly14() {
        let entity = MatchingType(zzzzz: "hello world")
        let poly = Poly14<MatchingType, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly.a, entity)
        XCTAssertNil(poly.b)
        XCTAssertNil(poly.c)
        XCTAssertNil(poly.d)
        ...
        let poly2 = Poly14<TestType1, MatchingType, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly2.b, entity)
        XCTAssertNil(poly2.a)
        XCTAssertNil(poly2.c)
        XCTAssertNil(poly2.d)
        ...
        XCTAssertNil(poly2.l)
        XCTAssertNil(poly2.m)
        XCTAssertNil(poly2.n)
        
        let poly3 = Poly14<TestType1, TestType2, MatchingType, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly3.c, entity)
        XCTAssertNil(poly3.a)
        XCTAssertNil(poly3.b)
        XCTAssertNil(poly3.d)
        ...
        XCTAssertNil(poly3.l)
        XCTAssertNil(poly3.m)
        XCTAssertNil(poly3.n)
        
        let poly4 = Poly14<TestType1, TestType2, TestType3,  MatchingType, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly4.d, entity)
        XCTAssertNil(poly4.a)
        XCTAssertNil(poly4.b)
        XCTAssertNil(poly4.c)
        ...
        XCTAssertNil(poly4.l)
        XCTAssertNil(poly4.m)
        XCTAssertNil(poly4.n)
        
        let poly5 = Poly14<TestType1, TestType2, TestType3, TestType4, MatchingType, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly5.e, entity)
        XCTAssertNil(poly5.a)
        XCTAssertNil(poly5.b)
        XCTAssertNil(poly5.c)
        ...
        XCTAssertNil(poly5.l)
        XCTAssertNil(poly5.m)
        XCTAssertNil(poly5.n)
        
        let poly6 = Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, MatchingType, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly6.f, entity)
        XCTAssertNil(poly6.a)
        XCTAssertNil(poly6.b)
        XCTAssertNil(poly6.c)
        ...
        XCTAssertNil(poly6.l)
        XCTAssertNil(poly6.m)
        XCTAssertNil(poly6.n)
        
        let poly7 = Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, MatchingType, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly7.g, entity)
        XCTAssertNil(poly7.a)
        XCTAssertNil(poly7.b)
        XCTAssertNil(poly7.c)
        ...
        XCTAssertNil(poly7.l)
        XCTAssertNil(poly7.m)
        XCTAssertNil(poly7.n)
        
        let poly8 = Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, MatchingType, TestType9, TestType10, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly8.h, entity)
        XCTAssertNil(poly8.a)
        XCTAssertNil(poly8.b)
        XCTAssertNil(poly8.c)
        ...
        XCTAssertNil(poly8.l)
        XCTAssertNil(poly8.m)
        XCTAssertNil(poly8.n)
        
        let poly9 = Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, MatchingType, TestType10, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly9.i, entity)
        XCTAssertNil(poly9.a)
        XCTAssertNil(poly9.b)
        XCTAssertNil(poly9.c)
        ...
        XCTAssertNil(poly9.l)
        XCTAssertNil(poly9.m)
        XCTAssertNil(poly9.n)
        
        let poly10 = Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, MatchingType, TestType11, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly10.j, entity)
        XCTAssertNil(poly10.a)
        XCTAssertNil(poly10.b)
        XCTAssertNil(poly10.c)
        ...
        XCTAssertNil(poly10.l)
        XCTAssertNil(poly10.m)
        XCTAssertNil(poly10.n)
        
        let poly11 = Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, MatchingType, TestType12, TestType13, TestType14>(entity)
        XCTAssertEqual(poly11.k, entity)
        XCTAssertNil(poly11.a)
        XCTAssertNil(poly11.b)
        XCTAssertNil(poly11.c)
        ...
        XCTAssertNil(poly11.l)
        XCTAssertNil(poly11.m)
        XCTAssertNil(poly11.n)
        
        let poly12 = Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, MatchingType, TestType13, TestType14>(entity)
        XCTAssertEqual(poly12.l, entity)
        XCTAssertNil(poly12.a)
        XCTAssertNil(poly12.b)
        XCTAssertNil(poly12.c)
        ...
        XCTAssertNil(poly12.k)
        XCTAssertNil(poly12.m)
        XCTAssertNil(poly12.n)
        
        let poly13 = Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, MatchingType, TestType14>(entity)
        XCTAssertEqual(poly13.m, entity)
        XCTAssertNil(poly13.a)
        XCTAssertNil(poly13.b)
        XCTAssertNil(poly13.c)
        ...
        XCTAssertNil(poly13.k)
        XCTAssertNil(poly13.l)
        XCTAssertNil(poly13.n)
        
        let poly14 = Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13, MatchingType>(entity)
           XCTAssertEqual(poly14.n, entity)
           XCTAssertNil(poly14.a)
           XCTAssertNil(poly14.b)
           XCTAssertNil(poly14.c)
           XCTAssertNil(poly14.d)
           XCTAssertNil(poly14.e)
           XCTAssertNil(poly14.f)
           XCTAssertNil(poly14.g)
           XCTAssertNil(poly14.h)
           XCTAssertNil(poly14.i)
           XCTAssertNil(poly14.j)
           XCTAssertNil(poly14.k)
           XCTAssertNil(poly14.l)
           XCTAssertNil(poly14.m)
    }
}
...
extension PolyTests {
    ...
    func test_Poly14_lookup() {
        let entity = decoded(type: TestType14.self, data: poly_entity14)
        let poly = decoded(type: Poly14<TestType1, TestType2, TestType3, TestType4, TestType5, TestType6, TestType7, TestType8, TestType9, TestType10, TestType11, TestType12, TestType13, TestType14>.self, data: poly_entity14)
        ...
        XCTAssertNil(poly[TestType11.self])
        XCTAssertNil(poly[TestType12.self])
        XCTAssertNil(poly[TestType13.self])
        XCTAssertEqual(entity, poly[TestType14.self])
    }
}
